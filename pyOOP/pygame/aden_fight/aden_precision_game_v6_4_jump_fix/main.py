...
class Player(pygame.sprite.Sprite):
    ...
    def release_jump(self):
        ...
        """
        was_super = self.jump_charge >= self.min_super_charge
        self.is_holding_jump = False
        self.jump_charge = 0
    ...
    def update(self, solids, crumble_group):
        ...
        # This does not delay the jump. It only adds extra upward force
        # while aden is already in the air and still moving upward.
        if self.is_holding_jump and not self.on_ground and self.vel_y < 0:
